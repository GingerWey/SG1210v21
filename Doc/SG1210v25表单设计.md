...
4. 状态图标
   ...
   - 元件：状态图片
      ...
      - 图集名称：picMAUAtlascsg
      - 图片序号：
	        - REG_RL_BCHRG_Level >= 90%:            picIdxMA_Battery41x26C4
	          (下降需 < 88%)
	        - REG_RL_BCHRG_Level >= 70%:            picIdxMA_Battery41x26C3
	          (下降需 < 68%)
	        - REG_RL_BCHRG_Level >= 30%:            picIdxMA_Battery41x26C2
	          (下降需 < 28%)
	        - else:                                 picIdxMA_Battery41x26C1
      - 位置坐标：(138,162)
      - 饱和度：
